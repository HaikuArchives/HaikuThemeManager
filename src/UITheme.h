...
#define B_UI_CONTROL_MARK_COLOR "h:c:CtlMk"
#define B_UI_LIST_BACKGROUND_COLOR "h:c:LstBg"
#define B_UI_LIST_SELECTED_BACKGROUND_COLOR "h:c:LstSBg"
#define B_UI_LIST_ITEM_TEXT_COLOR "h:c:LstTx"
#define B_UI_LIST_SELECTED_ITEM_TEXT_COLOR "h:c:LstSTx"
#define B_UI_SCROLL_BAR_THUMB_COLOR "h:c:SbThb"
